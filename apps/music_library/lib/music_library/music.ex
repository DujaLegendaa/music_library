defmodule MusicLibrary.Music do
  @moduledoc """
  The Music context.
  """
  ...
  def create_album(%Artist{} = artist, %Genre.Genre{} = genre, %Genre.SubGenre{} = subgenre, attrs \\ %{}) do
    %Album{}
    |> Album.changeset(attrs)
    |> Ecto.Changeset.put_assoc(:artist, artist)
    |> Ecto.Changeset.put_assoc(:genre, genre)
    |> Ecto.Changeset.put_assoc(:subgenre, subgenre)
    |> Repo.insert()
  end
